...
(ert-deftest org-cliplink-url-cached-p-test ()
  (let ((org-cliplink-cache '(("foo" . "bar")
                              ("herp" . "derp"))))
    (should (equal (cons "foo" "bar")
                   (org-cliplink-url-cached "foo")))
    (should (not (org-cliplink-url-cached "khooy")))))

(ert-deftest org-cliplink-cache-url-test ()
  (let ((org-cliplink-cache nil))
    (org-cliplink-cache-url "foo" "bar")
    (should (equal '(("foo" . "bar"))
                   org-cliplink-cache))
    (org-cliplink-cache-url "herp" "derp")
    (should (equal '(("herp" . "derp")
                     ("foo" . "bar"))
                   org-cliplink-cache))
    (org-cliplink-cache-url "foo" "bar")
    (should (equal '(("herp" . "derp")
...
(ert-deftest org-cliplink-clear-cache-test ()
  (let ((org-cliplink-cache '(("foo" . "bar")
                              ("herp" . "derp"))))
    (org-cliplink-clear-cache)
    (should (not org-cliplink-cache))))
